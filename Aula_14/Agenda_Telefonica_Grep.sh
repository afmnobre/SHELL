...
function _adicionar(){
    ...
    for dados in "${lista[@]}"; do
        ...
        echo "$chave:${dados[1]}:${dados[2]}:${dados[3]}:${dados[4]}" | tr 'A-Z' 'a-z' >> "$banco_de_dados"
}
